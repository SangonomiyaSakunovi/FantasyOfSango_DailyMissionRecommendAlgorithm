...
namespace SangoScripts_MaxLikehoodAndEbbinghasuAlgorithm
{
    ...
    public class emdeAlgorithmOld
    {
        ...
        public void FitMulticlassClassification(string csvPath, string zipPath)
        {
            ...
            var trainingDataView = mlContext.Data.LoadFromTextFile<EMDEDataSet>(csvPath, hasHeader: true, separatorChar: ',');

            //The Features is a special vector contain the nameof dimensions
            var dataProcessPipeline = mlContext.Transforms.Conversion.MapValueToKey(outputColumnName: "Label", inputColumnName: nameof(EMDEDataSet.Label))
                .Append(mlContext.Transforms.Concatenate("Features", nameof(EMDEDataSet.mission1),
                                                            nameof(EMDEDataSet.mission2),
                                                            nameof(EMDEDataSet.mission3),
                                                            nameof(EMDEDataSet.mission4))
            ...
            var trainer = mlContext.MulticlassClassification.Trainers.SdcaMaximumEntropy(labelColumnName: "Label", featureColumnName: "Features")
                .Append(mlContext.Transforms.Conversion.MapKeyToValue(outputColumnName: nameof(EMDEDataSet.Label), inputColumnName: "Label"));
        ...
        public void PredictMulticlassClassification(string modelPath, List<EMDEDataSet> userDataArray)
        {
            var mlContext = new MLContext();
            ...
            var predictEngine = mlContext.Model.CreatePredictionEngine<EMDEDataSet, EMDEPrediction>(trainedModel);
        ...
        private void TestMulticlassClassification()
        {
            ...
            EMDEDataSet testdMRDataSet1 = new EMDEDataSet()
            {
                mission1 = 136,
                mission2 = 144,
                mission3 = 95,
            ...
            EMDEDataSet testdMRDataSet2 = new EMDEDataSet()
            {
                mission1 = 135,
                mission2 = 144,
                mission3 = 127,
            ...
            List<EMDEDataSet> dMRDataSets = new List<EMDEDataSet>() { testdMRDataSet1, testdMRDataSet2 };
